...
function HackathonForm() {
    ...
    return (
        <div className="lg:grid grid-cols-2 bg-[#000F21] text-white" style={{ height: '100vh', overflowY: 'auto', overflowX: 'hidden' }}>
           <div className="row-span-5 bg-form-bg bg-center bg-cover h-full rounded-r-3xl block w-full bg-black text-white flex-col align-middle border-white border-opacity-10">
                <div>
