...
import Mount from "../images/hackathonpage.svg"
    ...
    return(
        <div className="[font-family:'Inter-Regular',Helvetica] w-screen bg-black bg-clip-text h-screen">
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="[text-shadow:0px_4px_37.2px_#0070f394] [font-family:'Inter-Bold',Helvetica] font-bold text-[#0070f3] md:text-[88px] text-[40px] tracking-[0] leading-[normal]">
                    &lt;DEVSPRINT’24 /&gt;
                </div>
